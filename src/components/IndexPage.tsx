    ...
    return(
        ...
        <section className='m-16 sm:max-w-full md:max-w-screen-md lg:max-w-screen-md'>
            ...
            <div className='md:text-sm lg:text-xl'>
                <p>Somos uma equipe apaixonada por transformar espaços em verdadeiras obras de arte.</p>
                <p>Nossa jornada começou com um sonho: <span className='font-bold'>trazer beleza e sofisticação para cada ambiente</span>, que é exatamente o que fazemos todos os dias.</p>
            </div>
